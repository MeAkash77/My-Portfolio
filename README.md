...
# Portfolio Demo
<img width="944" height="440" alt="Image" src="https://github.com/user-attachments/assets/c87920b4-7f1c-467e-82ce-0ab0e605989c" />
...
[**Live Demo**](https://my-portfolio-ruby-three-37.vercel.app/)
---
### 🎯 Project Structure
```bash
portfolio/
...
2. After forking, open your terminal and run the following commands to clone the repo:
  ...
  ```bash
  git clone https://github.com/MeAkash77/My-Portfolio.git
  ```
...
<div align="center"> Made with ❤️ by Akash </div>
